...
# def showImage():
#     file = filedialog.askopenfile(initialdir=os.getcwd(), title="Select Image File", filetypes=(
...
# btn = Button(frame, text="Open Image", command=showImage)
# btn.pack(side=tk.LEFT)

# btn = Button(frame, text="Open Image", command=lambda: exit)
